...
## The Problem
Copying video files from a Mac Plex server to a Windows Plex server causes hours of scanning and metadata downloading, especially problematic with slow internet at the remote location.

## The Solution
Copy the Plex database and metadata from your Mac (home) to Windows (remote) so Plex doesn't need to rescan or redownload anything.
...
**Note:** With very slow remote internet, this could take a long time but is still faster than letting Plex download metadata for your entire library.
