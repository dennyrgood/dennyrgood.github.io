...
Extracted from PDF: Mathes Online Utilities - Shutdown & Restart Checklist.pdf
...
https://dennyrgood.github.io/ → Landing page loads, health check shows "online"
...
Go to Cloudflare Dashboard → DNS → Delete:
• api.ldmathes.cc
• api-edit.ldmathes.cc
